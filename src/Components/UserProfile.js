    ...
    return (
        <div className="div" >
            ...
            <div className="dialog_box_profile">
                ...
                <br></br>
                <div className="div_row" style={{ justifyContent: "space-evenly" }}>
                    <div className="inner_div" align='left'>
                ...
                <label >AGE:</label>
                <br></br>
                <input type='date' value={getDOB} onChange={(data) => setDOB(data.target.value)} />
                <input type="text" value={getAge} onChange={(data) => { setAge(data.target.value) }} />
                <input type='submit' onClick={e => handelSave(e)} />
            </div>
        </div>
    )
