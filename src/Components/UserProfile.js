...
function Profile() {
    ...
    const handelSave = (e) => {
        ...
        axios.post('http://localhost:5000/users/complete_profile', data, {
            headers: {
    ...
    React.useEffect(() => {
        if (location.state) {
            ...
            setid(location.state.user.username)
            setEmail(location.state.user.email)
            setContact(location.state.user.contact)
        }
    }, [location])
    return (
        <div className="div" >
            ...
            <div className="dialog_box_profile" >
                ...
                <br></br>
                <Button variant="contained" onClick={e => handelSave(e)}>SIGNUP</Button>
