...
function Chngemail() {
    return (
      <React.Fragment>
        ...
        <Grid item xs ={4}>
        <TextField fullWidth size="small" id="standard-basic" label="Email Address" type='text' value={this.state.getEmail} onChange={(data) => this.setState({ getEmail: data.target.value })} InputProps={{readOnly: this.state.editEmail,}}/>
        </Grid>
