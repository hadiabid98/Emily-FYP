...
if __name__ == '__main__':
    ...
    X_train = np.load(
        'C:\\Users\\H.A.R\\Desktop\\Emily\\depression-detect\\src\\data\\processed\\train_samples.npz')
    y_train = np.load(
        'C:\\Users\\H.A.R\\Desktop\\Emily\\depression-detect\\src\\data\\processed\\train_labels.npz')
    X_test = np.load(
        'C:\\Users\\H.A.R\\Desktop\\Emily\\depression-detect\\src\\data\\processed\\test_samples.npz')
    y_test = np.load(
        'C:\\Users\\H.A.R\\Desktop\\Emily\\depression-detect\\src\\data\\processed\\test_labels.npz')
